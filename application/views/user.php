...
<div class="main">
  ...
  <div class="mainbar">
     ...
     <h2><p align="center"><font size="+1"> ثبت نام در سایت </font></p></h2>
        <form action="<?php echo base_url() ?>index.php/welcome/insert_data/" name="myform" id="myform" method="POST">
      <table cellspacing="2" cellpadding="2" border="0" align="">
        <tr>
          <td colspan="2" align="center"><font color="#990000" size="2"><?php echo  $this->session->userdata('welcome'); ?></font></td>
        </tr>
        <tr>
          <td align="right"><input type="text" name="FName" /></td>
          <td align="right">:نام</td>
        </tr>
        <tr>
          <td align="right"><input type="text" name="LName" /></td>
          <td align="right">:فامیلی</td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="right"><textarea cols="20" rows="5" name="Address"></textarea></td>
          <td align="right">:آدرس</td>
        </tr>
        <tr>
          <td align="right"><input type="text" name="City" /></td>
          <td align="right">:شهر</td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="right"><input type="password" name="Pass2" /></td>
          <td align="right">:تکرار رمز ورود  </td>
        </tr>
        <tr>
          <td align="right"><input type="submit" value="عضویت" /></td>
          <td>&nbsp;</td>
        </tr>        
        <tr>
