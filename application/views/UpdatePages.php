...
<div class="main">
       ...
       <p align="center" >
        <h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: ویرایش مطالب صفحات :.</font></p></h2>
        <p align="center" >
        ...
        <table  table cellspacing="2" cellpadding="2" border="0" align="center" >
          ...
          {
			  echo '
			  <form action="'.base_url().'index.php/welcome/update_data_pages/'.$row['id'].'"  method="POST">
			  <font size="2" >
				 <tr>
