...
<div class="main">
       ...
       <div align="center">
        ...
        <p align="center" >
        <h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: اضافه کردن منو صنایع دستی :.</font></p></h2>
        <p>&nbsp;</p>
        <form action="<?php echo base_url() ?>index.php/welcome/insert_link2/" name="myform" id="myform" method="POST" enctype="multipart/form-data">
      <table cellspacing="2" cellpadding="2" border="0"  align="center">
        <tr>
          <td align="right"><input type="text" name="name2" /></td>
          <td align="right" bgcolor="#9D0000"><font size="2" color="#FFFFFF" >:نام صفحه</font></td>
        </tr>
        <tr>
