...
<div class="main">
       ...
       <div align="center">
        <h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: اضافه کردن منو :.</font></p></h2>
  <p >&nbsp;</p>
    <form action="<?php echo base_url() ?>index.php/welcome/insert_link/" name="myform" id="myform" method="POST">
