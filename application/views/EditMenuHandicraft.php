...
<div class="main">
       ...
       <div align="center">
<h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: منو صنایع دستی :.</font></p></h2>
       ...
       <p align="center" >
        <table width="50%" border="0" align="center" >
          ...
          <tr  align="center" bgcolor="#990000" >
            ...
            <td><font size="3" color="#FFFFFF" >درج</font></td>
          ...
          foreach($info2 as $row)
          {
              echo '<font size="2" > <tr align="center" bgcolor="#FFE6E8">
				<td>
				<a href="'.base_url().'index.php/welcome/UpdateMenuHandicraft/'.$row['id_link2'].'" target="_self">
					<img src=" '.base_url().'images/edit.jpg " alt="ویرایش"/>
				</a>
				</td>
				<td>
				<a href="'.base_url().'index.php/welcome/delete_link2/'.$row['id_link2'].'" target="_self">
					<img src=" '.base_url().'images/delete.jpg " alt="حذف"/>
				</a>
				</td>
				<td>'.$row['Name_link2'].'</td>
              </tr> </font>';
              $i++;
          }
          ?>
