...
<div class="main">
       ...
       <div align="center">
       <p align="center" >
       <h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: ویرایش منو :.</font></p></h2>
        <p align="center" >
        ...
        <table  table cellspacing="2" cellpadding="2" border="0" align="center" >
          ...
          {
			  echo '
			  <form action="'.base_url().'index.php/welcome/update_link/'.$row['id_link'].'"  method="POST">
			  <font size="2" >
				 <tr>
				<td align="right"><input type="text" name="update_Name_link"  value="'.$row['Name_link'].'"/></td>
