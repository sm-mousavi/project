            ...
            <div class="menu_nav">
                <ul>
                    ...
                    foreach ($info as $row) {
                        ?>
                        <li>
                            <a href="<?php echo base_url() . 'index.php/welcome/show_menu/' . $row['id_link']; ?>"
                               target="_self">
...
<<<<<<< HEAD
    ...
    <div class="sidebar">
        <div class="gadget">
            <h2 class="star"><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: لینک‌ها
                        :. </font></h2>
            <div class="clr"></div>
            <ul class="sb_menu">
                <?php
                ...
                <li class="active">
                    <div align="right"><a href="<?php echo base_url() ?>index.php/welcome/albom">آلبوم تصاویر </a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="gadget">
            <h2 class="star"><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: ‌مطالب مرتبط
                        :. </font></h2>
            <div class="clr"></div>
            <ul class="ex_menu">
        ...
        <div class="gadget">
            <h2 class="star"><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: ورود به سایت
                        :. </font></h2>
            <div class="clr"></div>
            <p align="center"><font size="2">برای ورود به سایت لطفا نام کاربری و پسورد خود را وارد کنید </font>
                <form action="<?php echo base_url() ?>index.php/welcome/search_user/" method="POST">
                    <table cellspacing="2" cellpadding="2" border="0" align="center">
                        ...
                        <tr>
                            <td align="right"><a href="<?php echo base_url() ?>index.php/welcome/user"><font
                                            size="2" color="#000000"> در سایت عضو نیستید؟ </font></a></td>
                        </tr>
    ...
    <p align="center">
        <form action="<?php echo base_url() ?>index.php/welcome/search_user/" method="POST">
            <table cellspacing="2" cellpadding="2" border="0" align="center">
                ...
                <tr>
                    <td align="right"><a href="<?php echo base_url() ?>index.php/welcome/user"><font size="2"
                                                                                                     color="#000000"> در
                                سایت عضو نیستید؟ </font></a></td>
                </tr>
...
<div class="fbg">
    <div class="col c1">
        ...
        <p>
            <a href="<?php echo base_url() ?>index.php/welcome/albom"><img src="<?php echo base_url() ?>img/15.jpg"
                                                                           width="58" height="58" alt=""/></a>
            <a href="<?php echo base_url() ?>index.php/welcome/albom"><img src="<?php echo base_url() ?>img/4.jpg"
                                                                           width="58" height="58" alt=""/></a>
            <a href="<?php echo base_url() ?>index.php/welcome/albom"><img src="<?php echo base_url() ?>img/6.jpg"
                                                                           width="58" height="58" alt=""/></a></p>
        <p>
            <a href="<?php echo base_url() ?>index.php/welcome/albom"><img src="<?php echo base_url() ?>img/8.jpg"
                                                                           width="58" height="58" alt=""/></a>
            <a href="<?php echo base_url() ?>index.php/welcome/albom"><img src="<?php echo base_url() ?>img/10.jpg"
                                                                           width="58" height="58" alt=""/></a>
            <a href="<?php echo base_url() ?>index.php/welcome/albom"><img src="<?php echo base_url() ?>img/18.jpg"
                                                                           width="58" height="58" alt=""/></a></p>
    ...
    <div class="fbg">
        ...
        <div class="col c2">
            ...
            <p align="center"><font color="#000000">در راستای نیل به اهداف متعالی و تحقق ارزشهای ایرانی در سال 95 وارد
                    حرفه صنایع دستی شده و اقدام به طراحی سایت در این رابطه نمودیم. در سال‌های آینده نیز تصمیم به فروش
                    صنایع دستی از طریق همین سایت را نیز خواهیم داشت تا بتوان صنایع دستی ایران را به دنیا بشناسیم و به
                    راحتی توزیع کنیم</font></P>
        </div>
        <div class="col c3">

            <p align="right"><font face="Tahoma, Geneva, sans-serif" size="+1" color="#000000">.: ‌دسترسی سریع
                    :. </font></p>
            <?php
            $i = 1;
            foreach ($info as $row) {
...
<!-- END PAGE SOURCE -->
<div align="center">
    <p><font color="#FF7D7D" size="2"> www.Iranian.ir .: از انتخابتون متشکریم :. .: در صورت تمایل ما رو به دوستان خود
            معرفی کنید :. </font></p>
</div>
