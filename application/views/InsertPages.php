...
<div class="main">
       ...
       <div align="center">
        <p align="center" >
        <h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: اضافه کردن مطالب به صفحات :.</font></p></h2>
        <p >&nbsp;</p>
        
      <table cellspacing="2" cellpadding="2" border="0"  align="center">
        <tr>
          <td align="right">
 <form action="<?php echo base_url() ?>index.php/welcome/insert_data_pages/" name="myform" id="myform" method="POST" enctype="multipart/form-data">
          <select name="id_link" id="id_link">
          <?php
		   $i=1;
		   foreach($info as $row)
		   {
				echo'
				<option value="'.$row['id_link'].'">'.$row['Name_link'].'</option>';
				$i++;
		   }
	   	?>
       </select>
