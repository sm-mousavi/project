...
<div class="main">
       ...
       <div align="center">
        <h2><p align="center"><font face="Tahoma, Geneva, sans-serif" size="+1">.: صفحات :.</font></p></h2>
        ...
        <table width="100%" border="0" align="center" >
          ...
          foreach($query10 as $row)
          {
              echo '<font size="2" > <tr align="center" bgcolor="#FFE6E8">
				<td>
				<a href="'.base_url().'index.php/welcome/UpdatePages/'.$row['id'].'" target="_self">
					<img src=" '.base_url().'images/edit.jpg " alt="ویرایش"/>
				</a>
				</td>
				<td>
				<a href="'.base_url().'index.php/welcome/delete_data_pages/'.$row['id'].'" target="_self">
